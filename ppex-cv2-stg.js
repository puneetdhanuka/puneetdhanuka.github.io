...
function ppec_is_eligibility_cache_true() {
    console.log('eligibility already true stored in cache');
...
async function ppec_get_device_meta(payment_request_context) {
    ...
    device_meta.set_eligibility(device_meta.canMakePayment);
...
//         }
//     });
    console.log('device meta is = ' + device_meta);
    return device_meta;
}
async function ppec_check_app_and_cache_device_meta(payment_request_context) {
    ...
    console.log('device meta saved to cache is = ' + device_meta);
